...
def landing_page():
    ...
    # Key Features
    st.markdown("""
    <h2 style="text-align: center; color: white; font-size: 2rem; margin: 3rem 0 2rem 0;">Key Features</h2>
    """, unsafe_allow_html=True)
    ...
    <div class="footer-landing">
        <h3 style="margin-bottom: 1rem;">Ready to Transform Your EHR Experience?</h3>
        <p style="margin-bottom: 1.5rem;">Join hundreds of healthcare professionals already using our AI-Enhanced EHR System</p>
    </div>
    """, unsafe_allow_html=True)
...
# -------- SIDEBAR --------
    ...
    """, unsafe_allow_html=True)
        ...
        if st.button("← Back to Landing Page", key="back_btn", use_container_width=True):
            go_to_landing()
            st.rerun()
...
with col4:
    # Check for image in ehr_processedimages folder
